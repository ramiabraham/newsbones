...
function siteoptions_add_admin() {
    ...
    $tt_page = add_theme_page('News Bones Options', 'News Bones Options', 'edit_theme_options', 'siteoptions','siteoptions_options_page');
...
<div class="wrap" id="newsbones_admin_container">
...
<script type="text/javascript">
			...
			jQuery('#expand_options').click(function(){
				if(flip == 0){
					flip = 1;
					jQuery('#newsbones_admin_container #of-nav').hide();
					jQuery('#newsbones_admin_container #content').width(755);
					jQuery('#newsbones_admin_container .group').add('#newsbones_admin_container .group h2').show();
	
					jQuery(this).text('[-]');
					
				} else {
					flip = 0;
					jQuery('#newsbones_admin_container #of-nav').show();
					jQuery('#newsbones_admin_container #content').width(579);
					jQuery('#newsbones_admin_container .group').add('#newsbones_admin_container .group h2').hide();
					jQuery('#newsbones_admin_container .group:first').show();
					jQuery('#newsbones_admin_container #of-nav li').removeClass('current');
					jQuery('#newsbones_admin_container #of-nav li:first').addClass('current');
