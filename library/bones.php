...
/*********************
News Bones: Enqueue jQuery Masonry
*********************/
...
return '...  <div class="genericon genericon-link genericon-left"></div><a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __('Read', 'bonestheme') . get_the_title($post->ID).'">'. __('Article Continues', 'bonestheme') . '</a>';
}
