...
/**
 *
 * Create a roman numeral from a number, shows the year in the News Bones header area as the 'Volume' number
 *
 * @param int $num
 *
 * @return string
...
set_post_thumbnail_size( 320, 240, true ); // default Post Thumbnail dimensions (cropped)
}

// Add odd post class for homepage grid
function newsbones_oddeven_post_class ( $classes ) {
   global $current_class;
   $classes[] = $current_class;
   $current_class = ($current_class == 'odd') ? 'even' : 'odd';
   return $classes;
}
add_filter ( 'post_class' , 'newsbones_oddeven_post_class' );
global $current_class;
$current_class = 'odd';
